...
./network.sh deployCC -ccs 1 -ccv 1 -ccep "OR('Org1MSP.peer','Org2MSP.peer')"  -ccl go -ccp ../chaincode-simple-go/ -ccn asset-transfer-events-simple-go -cci InitAssetCounter
